 ...
 */
#include "mlek/fwk/tflm/TscanModel.hpp"
#include "mlek/log/log_macros.h"

const tflite::MicroOpResolver& arm::app::fwk::tflm::TscanModel::GetOpResolver()
{
    return this->m_opResolver;
}

bool arm::app::fwk::tflm::TscanModel::EnlistOperations()
{
